...
def main():
    ...
    with st.sidebar.expander("Configuração Geral", expanded=True):
        mapa_tipo = st.selectbox("Tipo de mapa", ["Padrão", "Satélite", "Terreno", "OpenStreetMap"])
    ...
    tiles_dict = {"Padrão": "CartoDB positron", "Satélite": "Esri WorldImagery", "Terreno": "Stamen Terrain", "OpenStreetMap": "OpenStreetMap"}
